            ...
            <div class="classy-nav-container breakpoint-off">
                ...
                <nav class="classy-navbar justify-content-between" id="cleverNav">
                    ...
                    <div class="classy-menu">
	                            ...
	                            <c:if test="${empty member}">
		                            ...
		                            <sec:authorize access="isAuthenticated()">                                                     
		                               <form:form action="${pageContext.request.contextPath }/login/logout.do" method="POST">      
		                                  ...
		                                  <input type="submit" class="btn active" value="Logout">
		                               </form:form>
		                            </sec:authorize>
	                        	</c:if>
	                         
		                        <c:if test="${!empty member}">
		                               <input type="button" class="btn active" onclick="showPopup('${member.id}')" value="Chatting">
                        ...
                        <c:if test="${empty member}">
                            <sec:authorize access="isAuthenticated()">         
	                            <div id="myinfo" class="login-state d-flex align-items-center">
	                                <div class="user-name mr-30">
	                                    <div class="dropdown">
	                                        <a class="dropdown-toggle" href="#" role="button" id="userName" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">${userInfo.id}</a>
	                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userName">
	                                            <a class="dropdown-item" href="member/profile">Profile</a>
	                                            <a class="dropdown-item" href="javascript:showPopup('${userInfo.id}')">Chat</a>
	                                            <a class="dropdown-item" href="javascript:logout('${userInfo.login_type}')">Logout</a>
	                                        </div>
	                                    </div>
	                                </div>
	                                <div class="userthumb">
                        ...
                        <c:if test="${!empty member}">
                            <sec:authorize access="isAuthenticated()">         
	                            <div id="myinfo" class="login-state d-flex align-items-center">
	                                <div class="user-name mr-30">
	                                    <div class="dropdown">
	                                        <a class="dropdown-toggle" href="#" role="button" id="userName" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">${member.id}</a>
	                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userName">
	                                            <a class="dropdown-item" href="member/profile">Profile</a>
	                                            <a class="dropdown-item" href="javascript:showPopup('${member.id}')">Chat</a>
	                                            <a class="dropdown-item" href="javascript:logout('${member.login_type}')">Logout</a>
	                                        </div>
	                                    </div>
	                                </div>
	                                <div class="userthumb">
