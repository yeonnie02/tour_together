...
<!-- jQuery 별도 로드가 필요합니다! -->
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=2d15fd5bf26911082d79838012f46ad9&libraries=clusterer"></script>
<script>
    ...
    $.get("map/korea/location.json", function(data) {
