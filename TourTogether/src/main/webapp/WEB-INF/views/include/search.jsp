		    ...
		    <tr>
		        <th scope="row">
		        	<select name="searchOpt" id="searchOpt" style="width:80px; height:30px;">
					  ...
					  <option value="lastName" <c:if test="${ 'lastName' == searchOpt }"> selected </c:if>> 성</option>
					  <option value="firstName" <c:if test="${ 'firstName' == searchOpt }"> selected </c:if>> 이름</option>
					  <option value="mem_class" <c:if test="${ 'mem_class' == searchOpt }"> selected </c:if>>등급</option>
