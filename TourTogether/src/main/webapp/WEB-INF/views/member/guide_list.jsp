...
<body>
    ...
    <div class="instructors-video d-flex align-items-center justify-content-center bg-img" style="background-image: url(../clever-img/bg-img/bg4.jpg);">
        <h2>Be The Best Guide</h2>
        <!-- video btn -->
    ...
    <section class="top-teacher-area section-padding-0-100">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-heading">
                        <h3>Top Guides in Every Field</h3>
                    </div>
                </div>
            </div>
